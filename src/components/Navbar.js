                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" to="/createweekendentry">Home</Link>
                            </li>
                        ...
                        {!localStorage.getItem('token') ? <form className="d-flex" role="search">
                            <Link className="btn btn-outline-primary" type="submit" to="/" >Login</Link>
                        </form> :
                            // <Link className="btn btn-outline-primary" type="submit" to="/login" onClick={handledLogout}>Logout</Link>
                            <ul className="navbar-nav mb-2 mb-lg-0" style={{ marginRight: "100px" }}>
                                <li className="nav-item">
