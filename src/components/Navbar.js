...
const Navbar = () => {
    ...
    let fullName = localStorage ? localStorage.getItem("fullName") : null;
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link active" to="/">Weekend Support</Link>
                                </li>

                                {/* <li className="nav-item">
                                <Link className="nav-link" to="/addweekendentry">Add Weekend Entry</Link>
                            </li> */}
                                ...
                                <Link className="nav-link dropdown-toggle" to="" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                 ...
                                 <ul className="dropdown-menu">
                                    <li><Link className="dropdown-item" to="/createuser">Create Users</Link></li>
                                    <li><Link className="dropdown-item" to="/updateuser">Update Users Info</Link></li>
                                </ul>
                            </li>:
                            <></>
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li><Link className="dropdown-item" to="/workedemployee">Worked Employee</Link></li>
                                    </ul>
                                </li>
                                :<></>
                                }
                            ...
                            {!localStorage.getItem('token') ? <form className="d-flex" role="search">
                                ...
                                // <Link className="btn btn-outline-primary" type="submit" to="/login" onClick={handledLogout}>Logout</Link>
